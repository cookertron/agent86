#pragma once
//
// Standard IBM PC ROM fonts for Code Page 437 (CP437)
// Public-domain bitmap font data extracted from IBM VGA/CGA BIOS ROMs.
// Each byte is one pixel row, MSB = leftmost pixel.
//
// Sources: spacerace/romfont (GitHub), IBM VGA BIOS 8x16, IBM VGA BIOS 8x8
//

#include <cstdint>

// IBM VGA 8x16 font: 256 glyphs, 16 bytes per glyph = 4096 bytes total
...
// IBM VGA 8x8 font: 256 glyphs, 8 bytes per glyph = 2048 bytes total
